...
public class MenuState extends GameState {
	...
	private Background help;

	private int currentChoice = 0;
	private String[] options = { "Start", "Help", "Options", "Store",
			"Leaderboards", "Achievements", "Quit" };
	private int slide;
	...
	public MenuState(GameStateManager gsm) {
		...
		help = new Background(gsm, "/overlays/initialhelp.png");
		help.setVector(0, 0);
